...
<head>
  ...
  <body <?php body_class(); ?>>
    ...
    <header id="topnav">
      <div class="container">
        <div class="logo"><a href="<?php echo home_url('/'); ?>"><img src="<?php echo $options['opt-upload-1']['url']; ?>" class="logo-light"><img src="<?php echo $options['opt-upload-2']['url']; ?>" class="logo-dark"></a></div>
